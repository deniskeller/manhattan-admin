...
import s from './InvestmentStatsTab.module.scss';
...
import { BaseLabel, BaseStatus, BaseTitle } from '@base/index';
...
const project_items = [
  {
    image: (
      ...
      >
        <g clip-path="url(#clip0_7443_218916)">
          <g clip-path="url(#clip1_7443_218916)">
            <path
    ...
    name: 'Teido payments LTD',
    status: 'available',
    investment: '$150,000.32',
    current_valuation: '$150,000.32',
    performance: '19 %',
    ...
    tags: ['FinTech', 'Finance', 'Compliance', 'Information Technologies'],
  },
  {
    image: (
      <svg
        ...
        xmlns="http://www.w3.org/2000/svg"
      >
        <g clip-path="url(#clip0_6547_241759)">
          <path
...
const InvestmentStatsTab: React.FC<Props> = () => {
  ...
  return (
    <>
      <div className={s.InvestmentStats}>
        <div className={s.InvestmentStats_GeneralInfo}>
          <div className={`${s.InvestmentStats_GeneralInfo_Item}`}>
            <div className={s.InvestmentStats_GeneralInfo_Item_Info}>
              <div className={s.InvestmentStats_GeneralInfo_Item_Info_Label}>
                <span>Balance</span>
              </div>
              <div className={s.InvestmentStats_GeneralInfo_Item_Info_Value}>
                $ 120,000.00
              </div>
            </div>
          ...
          <div
            className={`${s.InvestmentStats_GeneralInfo_Item} ${s.InvestmentStats_GeneralInfo_Item_WithoutGraph}`}
          >
            <div className={s.InvestmentStats_GeneralInfo_Item_Info}>
              <div className={s.InvestmentStats_GeneralInfo_Item_Info_Label}>
        ...
        <div className={s.InvestmentStats_InvestedProjects}>
          <BaseTitle
            type="app"
            className={s.InvestmentStats_InvestedProjects_Header}
          >
            Invested projects
          </BaseTitle>
        ...
        <div className={s.InvestmentStats_FinancialRecords}>
          <BaseTitle
            type="app"
            className={s.InvestmentStats_FinancialRecords_Header}
          >
            Financial records
          </BaseTitle>

          <div className={s.InvestmentStats_FinancialRecords_Table}>
            <Table
...
export default InvestmentStatsTab;
