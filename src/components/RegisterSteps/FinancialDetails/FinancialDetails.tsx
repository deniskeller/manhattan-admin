...
export const FinancialDetails: React.FC<Props> = ({fields,errors,
  ...
  return(<div>
    ...
    <div className={styles.ContainerForm}>
      <div className={styles.Form}>
        ...
        <div className={styles.spacer}/>
        <Input label="USDT wallet number"
               ...
               onChange={(e:any)=>{handleChange(e?.target?.value,"walletNumber") }}
        />
      </div>
      <div className={styles.bottomButtons}>
        <BaseButton variant={"dark"} type={"transparent"} arrow={"left"} title={"Step 5"} onClick={onBack}/>
