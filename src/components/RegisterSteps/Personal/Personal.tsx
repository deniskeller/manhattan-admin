...
export const PersonalInfo: React.FC<Props> = ({fields, errors, handleChange, onBack, onNext})=>{
    ...
    <div className={styles.ContainerForm}>
      <div className={styles.Form}>
        ...
        <Input.Phone label={"Phone"}
                     ...
                     onChange={(val:any)=>{handleChange(val,"phone") }}
                     valueCodeInitial={fields.code}
                     onChangeCode={(val:any)=>{handleChange(val,"code") }}
        />
        <div className={styles.spacer}/>
        <Input.Calendar
          label={"Birth date"}
          ...
          onChange={(val:any)=>{handleChange(val,"birthDate") }}
        />
        <div className={styles.spacer}/>
        ...
        <div className={styles.bottomForm}>
          Already have account?&nbsp;<BaseLink href={"/auth"}> Log in </BaseLink>
        </div>
      </div>
