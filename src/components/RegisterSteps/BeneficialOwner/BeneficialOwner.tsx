...
type Props = {
  ...
  handleChange: (
    e: any,
    name: string,
    listName?: 'ubosList' | 'shareholdersList',
    index?: number
  ) => void;
  onNext: () => void;
  onBack: () => void;
      ...
      <div className={styles.ContainerForm}>
        <div className={styles.Form}>
          <div className={styles.SubtitleForm}>
            Please, write in information about beneficial owners and
            shareholders
          </div>
          <Checkbox
            theme={'dark'}
            label={'1 Ultimate Beneficial Owner added'}
            checked={fields.beneficialOwner}
            onChange={(e: any) => {
              handleChange(e?.target?.checked, 'beneficialOwner');
            }}
          />
          <div className={styles.spacerBig} />
          <Checkbox
            theme={'dark'}
            label={'Shareholders ownership stake ≥ 99% '}
            checked={fields.ownStake}
            onChange={(e: any) => {
              handleChange(e?.target?.checked, 'ownStake');
            }}
          />
              ...
              <>
                ...
                <div
                  className={`${styles.RowTooltip} ${
                    index > 0 && styles.RowTooltip_Between
                  }`}
                >
                  <div
                    className={`${styles.RowTooltip_LeftText} ${
                      index > 0 && styles.RowTooltip_LeftText_Noborder
                    }`}
                  >
                  ...
                  {index === 0 && (
                    <div className={styles.RowTooltip_RightText}>
                      Maximum 4{' '}
                      <span className={styles.RowTooltip_RightTextLight}>
                        {' '}
                        (Ownership stake ≥ 25%)
                      </span>
                    </div>
                ...
                <div className={styles.InputsRow}>
                  <Input
                    ...
                    variant={
                      errors.ubosList[index]['firstName'].isError
                        ? 'error'
                        : 'default'
                    }
                  ...
                  <Input
                    ...
                    variant={
                      errors.ubosList[index]['lastName'].isError
                        ? 'error'
                        : 'default'
                    }
                ...
                <Input.Calendar
                  ...
                  value={ubo.birthDate}
                  variant={
                    errors.ubosList[index]['birthDate'].isError
                      ? 'error'
                      : 'default'
                  }
                  message={errors.ubosList[index]['birthDate'].errorText}
                  onChange={(e: any) => {
                    handleChange(e, 'birthDate', 'ubosList', index);
                  }}
                />
                <div className={styles.spacer} />
                <div className={styles.InputsRow}>
                  <Input
                    ...
                    required
                    variant={
                      errors.ubosList[index]['ownStake'].isError
                        ? 'error'
                        : 'default'
                    }
                  ...
                  <Input
                    ...
                    variant={
                      errors.ubosList[index]['taxId'].isError
                        ? 'error'
                        : 'default'
                    }
                ...
                <Checkbox
                  theme={'dark'}
                  label={'Existence of criminal records'}
                ...
                <FileDrop
                  ...
                  maxSize={3}
                  variant={
                    errors.ubosList[index]['filesPassport'].isError
                      ? 'error'
                      : 'default'
                  }
                ...
                <Input.Phone
                  ...
                  variant={
                    errors.ubosList[index]['phone'].isError
                      ? 'error'
                      : 'default'
                  }
                  ...
                  onChange={(val: any) => {
                    handleChange(val, 'phone', 'ubosList', index);
                  }}
                ...
                <Input.Email
                  ...
                  placeholder={'Email'}
                  variant={
                    errors.ubosList[index]['email'].isError
                      ? 'error'
                      : 'default'
                  }
                  ...
                  value={ubo.email}
                  onChange={(e: any) => {
                    handleChange(e?.target?.value, 'email', 'ubosList', index);
                  }}
                />
                <div className={styles.spacer} />
                <Input
                  label="Participation in other businesses"
                  ...
                  <>
                    <div className={styles.InputsRow}>
                      <Input
                        ...
                        placeholder="Enter First name"
                        variant={
                          errors.shareholdersList[index]['firstName'].isError
                            ? 'error'
                            : 'default'
                        }
                        message={
                          errors.shareholdersList[index]['firstName'].errorText
                        }
                        required
                      ...
                      <Input
                        ...
                        placeholder="Enter Last name"
                        variant={
                          errors.shareholdersList[index]['lastName'].isError
                            ? 'error'
                            : 'default'
                        }
                        message={
                          errors.shareholdersList[index]['lastName'].errorText
                        }
                        required
                    ...
                    <Input.Calendar
                      ...
                      variant={
                        errors.shareholdersList[index]['birthDate'].isError
                          ? 'error'
                          : 'default'
                      }
                      message={
                        errors.shareholdersList[index]['birthDate'].errorText
                      }
                      onChange={(e: any) => {
                        handleChange(e, 'birthDate', 'shareholdersList', index);
                      }}
                    />
                    <div className={styles.spacer} />
                    <div className={styles.InputsRow}>
                      <Input
                        ...
                        placeholder="Ownership stake, %"
                        variant={
                          errors.shareholdersList[index]['ownStake'].isError
                            ? 'error'
                            : 'default'
                        }
                        message={
                          errors.shareholdersList[index]['ownStake'].errorText
                        }
                        required
                      ...
                      <Input
                        ...
                        placeholder="Tax ID number"
                        variant={
                          errors.shareholdersList[index]['taxId'].isError
                            ? 'error'
                            : 'default'
                        }
                        message={
                          errors.shareholdersList[index]['taxId'].errorText
                        }
                        required
                        value={holder.taxId}
                        onChange={(e: any) => {
                    ...
                    <FileDrop
                      ...
                      maxSize={3}
                      variant={
                        errors.shareholdersList[index]['filesPassport'].isError
                          ? 'error'
                          : 'default'
                      }
                      message={
                        errors.shareholdersList[index]['filesPassport']
                          .errorText
                      }
                    />
                    <div className={styles.spacer} />
                    ...
                    <Input.Phone
                      ...
                      variant={
                        errors.shareholdersList[index]['phone'].isError
                          ? 'error'
                          : 'default'
                      }
                      message={
                        errors.shareholdersList[index]['phone'].errorText
                      }
                      messageCode={
                        errors.shareholdersList[index]['code'].errorText
                      }
                      isErrorPhone={
                        errors.shareholdersList[index]['phone'].isError
                      }
                      isErrorCode={
                        errors.shareholdersList[index]['code'].isError
                      }
                      onChange={(val: any) => {
                        handleChange(val, 'phone', 'shareholdersList', index);
                      }}
                      onChangeCode={(val: any) => {
                        handleChange(val, 'code', 'shareholdersList', index);
                      }}
                    />
                    <div className={styles.spacer} />
                    ...
                    <Input.Email
                      ...
                      required
                      variant={
                        errors.shareholdersList[index]['email'].isError
                          ? 'error'
                          : 'default'
                      }
                      message={
                        errors.shareholdersList[index]['email'].errorText
                      }
                      value={holder.email}
                      onChange={(e: any) => {
                        handleChange(
                  ...
                  <>
                    <div className={styles.InputsRow}>
                      <SelectComponent.Simple
                        ...
                        variant={
                          errors.shareholdersList[index]['companyCountry']
                            .isError
                            ? 'error'
                            : 'default'
                        }
                      ...
                      <Input
                        label="Company name"
                        variant={
                          errors.shareholdersList[index]['lastName'].companyName
                            ? 'error'
                            : 'default'
                        }
                        message={
                    ...
                    <div className={styles.InputsRow}>
                      <Input.Calendar
                        ...
                        variant={
                          errors.shareholdersList[index]['companyRegdate']
                            .isError
                            ? 'error'
                            : 'default'
                        }
                      ...
                      <Input
                        ...
                        variant={
                          errors.shareholdersList[index]['companyRegNumber']
                            .isError
                            ? 'error'
                            : 'default'
                        }
                    ...
                    <div className={styles.InputsRow}>
                      <Input
                        ...
                        placeholder="Ownership stake, %"
                        variant={
                          errors.shareholdersList[index]['companyOwnStake']
                            .isError
                            ? 'error'
                            : 'default'
                        }
                      ...
                      <Input
                        ...
                        placeholder="Tax ID number"
                        variant={
                          errors.shareholdersList[index]['companyTaxId'].isError
                            ? 'error'
                            : 'default'
                        }
                        message={
                          errors.shareholdersList[index]['companyTaxId']
                            .errorText
                        }
                        required
                    ...
                    <FileDrop
                      ...
                      maxSize={3}
                      variant={
                        errors.shareholdersList[index]['filesBeneficiary']
                          .isError
                          ? 'error'
                          : 'default'
                      }
                    ...
                    <Input.Phone
                      ...
                      variant={
                        errors.shareholdersList[index]['companyPhone'].isError
                          ? 'error'
                          : 'default'
                      }
                      message={
                        errors.shareholdersList[index]['companyPhone'].errorText
                      }
                      messageCode={
                        errors.shareholdersList[index]['companyCode'].errorText
                      }
                      isErrorPhone={
                        errors.shareholdersList[index]['companyPhone'].isError
                      }
                      isErrorCode={
                        errors.shareholdersList[index]['companyCode'].isError
                      }
                      onChange={(val: any) => {
                        handleChange(
                          val,
                    ...
                    <Input.Email
                      ...
                      required
                      variant={
                        errors.shareholdersList[index]['companyEmail'].isError
                          ? 'error'
                          : 'default'
                      }
                      message={
                        errors.shareholdersList[index]['companyEmail'].errorText
                      }
