...
export const Select = function <T>({
  ...
  const CustomSelect = React.forwardRef(function CustomSelect<
    ...
    const StyledPopper = styled(PopperUnstyled)([
      ...
      css`         
                border-radius: 2px;
      & .MuiSelect-listbox, & .MuiSelect-listbox:active,  & .MuiSelect-listbox:focus, & .MuiSelect-listbox:target, & .MuiSelect-listbox:focus-visible{
      ...
      <div style={{position: "relative"}}>
       {/* {label && (
        ...
        <InputLabel
          id={randomId}
          variant={"outlined"}
          css={ [tw`flex flex-row-reverse justify-end gap-1 -ml-1.5 pr-1 leading-4 h-full`,
            !required && tw`pl-1`,
        ...
        <SelectUnstyled
          ...
          autoFocus={false}
          renderValue={(option) => {
            console.log("props.renderValue", props.renderValue, "option", option);
      ...
      >
        <ListSubheader>
          <Input
            ...
            noBorder={true}
            height={44}
            left={ <Search color={"rgba(255, 255, 255, 0.5)"} width={18} height={18} style={{marginRight: '5px'}}/>}
            ref={(input)=>{
              if(input != null) {
