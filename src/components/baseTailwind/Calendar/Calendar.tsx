              ...
              &__tile {                         
                ...
                &--active {
                  &.react-calendar__month-view__days__day::before {
                    ...
                    left: 50%;
                    height: 100%;
                    ${tw`bg-white border border-blue-light-600 rounded-full aspect-square -translate-x-1/2`}
                  }
                }

                &--now {
                  ${tw`text-blue-light-600`}
                }

                &--now.react-calendar__month-view__days__day {
                  &::before {
                    content: "•";
                    position: absolute;
                    top: 50%;
                    left: 50%;
                    height: 100%;
                    ${tw`text-blue-light-600 rounded-full aspect-square -translate-x-1/2`}
                  }
                }
              }
